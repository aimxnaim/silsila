 ...
 *
 * Cards or the same figures as a table, on a switch. The cards answer "which
 * one is big" from across the room; the table answers "how do they compare"
 * for a reader who has stopped browsing and started counting. Showing both at
 * once made the page a long scroll where the second half only repeated the
 * first, so the reader picks the one that suits the question they arrived
 * with. Both open the same department page, so neither is a dead end.
 */
...
export function DepartmentsView({
  ...
  return (
    <div className="stack gap-5">
      <div className="row gap-4 wrap spread" style={{ alignItems: 'flex-start' }}>
        <div>
        ...
        <div className="segmented no-print" role="group" aria-label="How to show departments">
